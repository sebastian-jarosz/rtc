...
GENERATOR_INPUT_TRN_REF_COLUMNS = [COL_MINUTE_PER_KM_SPEED_TRAINING, COL_MINUTE_PER_KM_THRESHOLD_TRAINING,
                                   COL_MINUTE_PER_KM_INTERVAL_TRAINING, COL_MINUTE_PER_KM_RUN_UP_TRAINING,
                                   COL_MINUTE_PER_KM_RUNWAY]

# Generator output dict {column_name:question}
Q_GENERATOR_OUTPUT = {
    COL_TIME_1KM: Q_TIME_1KM,
    COL_TIME_5KM: Q_TIME_5KM,
    COL_TIME_10KM: Q_TIME_10KM,
    COL_TIME_21KM: Q_TIME_21KM,
    COL_TIME_42KM: Q_TIME_42KM,
}
